...
public abstract class SectioningAdapter extends RecyclerView.Adapter<SectioningAdapter.ViewHolder> {
    ...
    public static class GhostHeaderViewHolder extends ViewHolder {
        ...
        @Override public boolean isGhostHeader() {
            return true;
        }
    }
    ...
    public static class FooterViewHolder extends ViewHolder {
        ...
        @Override public boolean isFooter() {
            return true;
        }
    }
    ...
    /**
     * For scenarios with multiple types of headers, override this to return an integer in range [0,255] specifying a custom type for this
     * header.
    ...
    /**
     * For scenarios with multiple types of footers, override this to return an integer in range [0, 255] specifying a custom type for
     * this footer.
    ...
    /**
     * For scenarios with multiple types of items, override this to return an integer in range [0,255] specifying a custom type for the
     ...
     */
    public abstract ItemViewHolder onCreateItemViewHolder(ViewGroup parent, int itemUserType);
     ...
     */
    public abstract void onBindItemViewHolder(ItemViewHolder viewHolder, int sectionIndex, int itemIndex, int itemUserType);
     ...
     * @param headerUserType if getSectionHeaderUserType is overridden to provide custom header types, this will be the type for this
     *                       header
     */
     ...
     * @param footerUserType if getSectionFooterUserType is overridden to provide custom footer types, this will be the type for this
     *                       footer
     */
    ...
    public int getPositionOfItemInSection(int sectionIndex, int adapterPosition) {
        ...
        if (localPosition > section.length) {
            throw new IndexOutOfBoundsException("adapterPosition: " + adapterPosition + " is beyond sectionIndex: " + sectionIndex + " "
    ...
    /**
     * Given a sectionIndex index, and an offset into the sectionIndex where 0 is the header, 1 is the ghostHeader, 2 is the first item
     * in the sectionIndex, return the corresponding "global" adapter position
     *
    ...
    private void notifySectionItemRangeInserted(int sectionIndex, int fromPosition, int number, boolean updateSelectionState) {
        if (sections == null) {
            ...
            if (fromPosition > section.numberOfItems) {
                throw new IndexOutOfBoundsException("itemIndex adapterPosition: " + fromPosition + " exceeds sectionIndex numberOfItems: " +
    ...
    private void notifySectionItemRangeRemoved(int sectionIndex, int fromPosition, int number, boolean updateSelectionState) {
        if (sections == null) {
            ...
            if (fromPosition + number > section.numberOfItems) {
                throw new IndexOutOfBoundsException("itemIndex adapterPosition: " + fromPosition + number + " exceeds sectionIndex " +
    ...
    public void notifySectionItemChanged(int sectionIndex, int itemIndex) {
        if (sections == null) {
            ...
            if (itemIndex >= section.numberOfItems) {
                throw new IndexOutOfBoundsException("itemIndex adapterPosition: " + itemIndex + " exceeds sectionIndex numberOfItems: " +
                                                            section.numberOfItems);
            }
            if (section.hasHeader) {
                itemIndex += 2;
    ...
    public void notifySectionFooterInserted(int sectionIndex) {
        if (sections == null) {
            ...
            if (!section.hasFooter) {
                throw new IllegalArgumentException("notifySectionFooterInserted: adapter implementation reports that section " +
                                                           sectionIndex + " does not have a footer");
            }
    ...
    public void notifySectionFooterRemoved(int sectionIndex) {
        if (sections == null) {
            ...
            Section section = this.sections.get(sectionIndex);
            if (section.hasFooter) {
                throw new IllegalArgumentException("notifySectionFooterRemoved: adapter implementation reports that section " +
                                                           sectionIndex + " has a footer");
            }
    ...
    public void notifySectionFooterChanged(int sectionIndex) {
        if (sections == null) {
            ...
            Section section = this.sections.get(sectionIndex);
            if (!section.hasFooter) {
                throw new IllegalArgumentException("notifySectionFooterChanged: adapter implementation reports that section " +
                                                           sectionIndex + " does not have a footer");
            }
    ...
    @Override public int getItemViewType(int adapterPosition) {
        if (sections == null) {
            buildSectionIndex();
        }
    ...
    @Override public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        throw new IndexOutOfBoundsException("unrecognized viewType: " + viewType + " does not correspond to TYPE_ITEM, TYPE_HEADER or " +
                                                    "TYPE_FOOTER");
    }

    @Override public void onBindViewHolder(ViewHolder holder, int adapterPosition) {
        ...
        switch (baseType) {
            ...
            default:
                throw new IllegalArgumentException("unrecognized viewType: " + baseType + " does not correspond to TYPE_ITEM, " +
                                                           "TYPE_HEADER, TYPE_GHOST_HEADER or TYPE_FOOTER");
        }
    }
