...
public class VerticalDividerItemDecoration extends FlexibleDividerDecoration {
    ...
    @Override protected Rect getDividerBound(int position, RecyclerView parent, View child) {
        ...
        bounds.bottom = parent.getHeight() - parent.getPaddingBottom() - mMarginProvider.dividerBottomMargin(position,
                                                                                                             parent) + transitionY;
    ...
    @Override protected void setItemOffsets(Rect outRect, int position, RecyclerView parent) {
        if (mPositionInsideItem) {
            outRect.set(0, 0, 0, 0);
            return;
        }
    ...
    public static class Builder extends FlexibleDividerDecoration.Builder<Builder> {
        ...
        private MarginProvider mMarginProvider = new MarginProvider() {
            @Override public int dividerTopMargin(int position, RecyclerView parent) {
                return 0;
            }

            @Override public int dividerBottomMargin(int position, RecyclerView parent) {
                return 0;
            }
        };
